...
class ForumController extends AbstractController
{
    ...
    #[Route('/forums', name: 'app_forum_indextemp', methods: ['GET'])]
    public function showForum(EntityManagerInterface $entityManager)
    {
        // Récupérer tous les articles
        $forum = $entityManager->getRepository(Forum::class)->findAll();
