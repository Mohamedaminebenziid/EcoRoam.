...
public class MainFX extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            FXMLLoader loader1 = new FXMLLoader(getClass().getResource("/user/login.fxml"));
            Parent root1 = loader1.load();
            Scene scene1 = new Scene(root1);
            Stage stage1 = new Stage(); // Create a new stage
            stage1.setTitle("Ecoroam ");
            stage1.setScene(scene1);
            stage1.show();

            // Load the FXML file for the second window
           /* FXMLLoader loader2 = new FXMLLoader(getClass().getResource("/frontoffice/destinationdesplay.fxml"));
